---
title: "Programming Practice: Lab 11"
execute:
  enabled: true
  echo: true
  cache: true
...
**Task 2.** Extend the request handler so that it applies a black-and-white filter on an image specified in request URL and returns the resulting image.
